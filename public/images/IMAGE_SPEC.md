...
### 시그니처 탭 — Brand & Goods (`tabs/brand-goods/`)
```
main.jpg — 1400×1000px
  바라쿠다 라이프스타일 굿즈 대표 연출샷.
  배경은 공간 또는 중립 톤. 브랜드 감도가 살아있는 구도.
  머그, 텀블러, 원두 패키지 등 1-2개 오브제 중심.

sub-1.jpg — 800×640px
  굿즈 컬렉션 배치 샷 (테이블 위 여러 제품 플랫레이 또는 사선 구도)
  브랜드 패키지 + 소품이 자연스럽게 어우러진 장면.

sub-2.jpg — 800×640px
  일상 맥락 굿즈 샷 (책상, 창가, 카페 테이블 위에 놓인 장면)
  사용 중인 느낌. 라이프스타일 무드 강조.
```
