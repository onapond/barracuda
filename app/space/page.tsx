...
const spacePage = {
  ...
  eventTypes: [
    { title: "프라이빗 파티", description: "가까운 사람들과 조용하게 모이는 자리", image: "/images/cafe.jpg", imageAlt: "프라이빗 파티를 상상할 수 있는 공간 이미지" },
    { title: "브랜드 모임", description: "소개와 공개에 어울리는 정제된 분위기", image: assetPaths.space[1], imageAlt: "브랜드 모임을 상상할 수 있는 공간 이미지" },
    { title: "북클럽", description: "대화와 집중이 함께하는 조용한 시간", image: assetPaths.space[2], imageAlt: "북클럽과 소규모 토크를 상상할 수 있는 공간 이미지" },
    { title: "워크숍", description: "유연하게 운영할 수 있는 소규모 프로그램", image: "/images/cafe.jpg", imageAlt: "워크숍 진행을 상상할 수 있는 공간 이미지" },
    { title: "쇼케이스", description: "제품과 무드를 차분하게 보여주는 장면", image: assetPaths.space[1], imageAlt: "쇼케이스를 상상할 수 있는 공간 이미지" },
    { title: "크리에이티브 밋업", description: "자연스럽게 연결되는 협업과 네트워킹", image: assetPaths.space[2], imageAlt: "크리에이티브 밋업을 상상할 수 있는 공간 이미지" },
  ],
  gallery: [
    { src: assetPaths.space[0], alt: "Baracuda interior gallery image one" },
    { src: assetPaths.space[1], alt: "Baracuda interior gallery image two" },
    { src: assetPaths.space[2], alt: "Baracuda interior gallery image three" },
    { src: assetPaths.space[0], alt: "Baracuda interior gallery image four" },
    { src: assetPaths.space[1], alt: "Baracuda interior gallery image five" },
    { src: assetPaths.space[2], alt: "Baracuda interior gallery image six" },
  ],
  rentalInfo: [
