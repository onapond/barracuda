      ...
      <div className="relative h-[24rem] sm:h-[30rem] lg:h-[38rem]">
        ...
        <Container className="relative flex h-full items-end justify-center pb-10 text-center sm:pb-14 lg:pb-18">
          <div className="max-w-[46rem] text-white">
            <h1 className="font-heading text-[2.2rem] font-semibold leading-[1.03] tracking-[-0.04em] whitespace-pre-line max-w-none sm:text-[3.4rem] lg:text-[4.75rem]">
              {title}
            </h1>
            <p className="mx-auto mt-5 max-w-[36rem] text-[0.9375rem] leading-[1.7] text-white/92 break-keep sm:text-base sm:leading-8 lg:text-[1.08rem] lg:leading-9">
              {description}
            </p>
            {ctaHref && ctaLabel ? (
              <Link
